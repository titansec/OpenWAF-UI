(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["policy-policy-module~server-server-module"],{
...
/***/ "./src/app/@theme/http/basichttp.service.ts":
/*!**************************************************!*\
  !*** ./src/app/@theme/http/basichttp.service.ts ***!
  \**************************************************/
/*! exports provided: BasicHttpService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BasicHttpService", function() { return BasicHttpService; });
...
var BasicHttpService = /** @class */ (function () {
    function BasicHttpService(_http, router) {
        this._http = _http;
        this.router = router;
        this.errorCode = {
            401: '服务器验证失败',
    ...
    BasicHttpService.prototype.NewReqOpts = function (header, param) {
        if (header) {
    ...
    BasicHttpService.prototype.MyRequest = function (method, url, reqOpts, requireAuth) {
        var _this = this;
        // 添加认证信息
        /*if (requireAuth) {
    ...
    BasicHttpService.prototype.MyList = function (url, reqOpts) {
        return this.MyRequest('get', url, reqOpts)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
            return res;
        }));
    };
    BasicHttpService.prototype.MyPolicy = function (url, reqOpts) {
        return this.MyRequest('get', url, reqOpts)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
            var rows = [];
    ...
    BasicHttpService.prototype.MyGet = function (url, reqOpts) {
        return this.MyRequest('get', url, reqOpts);
    };
    BasicHttpService.prototype.MyPost = function (url, body, reqOpts, requireAuth) {
    ...
    BasicHttpService.prototype.MyPut = function (url, body, reqOpts, requireAuth) {
        if (requireAuth === void 0) { requireAuth = true; }
        if (body != null) {
            reqOpts.body = body;
        }
    ...
    BasicHttpService.prototype.MyDelete = function (url, reqOpts, requireAuth, where) {
        if (requireAuth === void 0) { requireAuth = true; }
        if (where) {
...
/***/ "./src/app/pages/server/server.service.ts":
/*!************************************************!*\
  !*** ./src/app/pages/server/server.service.ts ***!
  \************************************************/
...
var ServerService = /** @class */ (function () {
    function ServerService(_basicHttpService) {
        this._basicHttpService = _basicHttpService;
        this.accessRuleUrl = '/access_rule';
        this.policyUrl = '/policy/policy_uuids';
        this.getAccessRuleList = function () {
        ...
        this.addAccessRule = function (data, user, uuid) {
            var opt = this._basicHttpService.NewReqOpts();
            if (uuid) {
                user = user + '/' + uuid;
            }
        ...
        this.setAccessRule = function (data, user, uuid) {
            var opt = this._basicHttpService.NewReqOpts();
            return this._basicHttpService.MyPut(this.accessRuleUrl + '/' + user + '/' + uuid, data, opt, true);
        };
    }
    ServerService.prototype.deleteAccessRule = function (user, uuid) {
        var opt = this._basicHttpService.NewReqOpts();
...
//# sourceMappingURL=policy-policy-module~server-server-module.js.map